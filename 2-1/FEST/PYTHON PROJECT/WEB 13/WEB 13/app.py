...
# Main page heading
st.title("Object Detection & Tracking using YOLOv8")

# '''Modify Team member'''
# Create two columns for each row
# '''Team Leader'''
col1, col2, col3 = st.columns([3, 6, 4])  # Adjust as needed

with col1:
    st.subheader("**Team Leader:**")
with col2:
    st.subheader("Md. An Nahian Prince")
with col3:
    st.subheader("**ID:** 12105007")
...
with col2:
    st.subheader("Shithi Rani Roy")
with col3:
    st.subheader("**ID:** 12105009")

with col1:
    st.subheader("**Team Assistant:**")
with col2:
    st.subheader("Romjan Hossain")
with col3:
    st.subheader("**ID:** 12105034")
# Sidebar
